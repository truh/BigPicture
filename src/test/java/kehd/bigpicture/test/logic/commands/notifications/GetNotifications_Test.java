...
public class GetNotifications_Test {
    ...
    public void execution() {
        ...
        assertEquals("Id sollte wie gegeben sein.", "1", nodes.get(0).getNumberValue("id"));
        assertEquals("Id sollte wie gegeben sein.", "2", nodes.get(1).getNumberValue("id"));
        assertEquals("Id sollte wie gegeben sein.", "3", nodes.get(2).getNumberValue("id"));
    }
}
