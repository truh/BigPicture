...
public class Executor_Test {
    ...
    public void correctExecution() throws InvalidSyntaxException {
        ...
        Command command = new Command() {
			...
			@Override
			public JsonNodeBuilder execute(String username,
					Map<String, String> params) throws ParameterException {
				paramMap = params;
				executionCount ++;
        ...
        String result = executor.execute("testCommand","tes", new HashMap<String, String>(){{
            put("param", "test");
        }});
